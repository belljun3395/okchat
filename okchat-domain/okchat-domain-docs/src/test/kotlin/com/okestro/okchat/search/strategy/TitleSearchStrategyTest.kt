...
@DisplayName("TitleSearchStrategy Unit Tests")
class TitleSearchStrategyTest {
    ...
    private lateinit var strategy: TitleSearchStrategy
    ...
    fun setUp() {
        ...
        weightConfig = mockk()
        fieldConfig = mockk()
        strategy = TitleSearchStrategy(searchClient, embeddingModel, weightConfig, fieldConfig)
    }
    ...
    fun `should return strategy name`() {
        ...
        // then
        name shouldBe "Title Hybrid Search"
    }
}
