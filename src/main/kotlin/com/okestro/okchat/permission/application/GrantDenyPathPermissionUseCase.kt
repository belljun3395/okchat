...
class GrantDenyPathPermissionUseCase(
    ...
    fun execute(useCaseIn: GrantDenyPathPermissionUseCaseIn): GrantDenyPathPermissionUseCaseOut {
        ...
        if (existing != null && existing.permissionLevel == PermissionLevel.DENY) {
            ...
            return GrantDenyPathPermissionUseCaseOut(existing)
        }
        ...
        return GrantDenyPathPermissionUseCaseOut(savedPermission)
    }
}
